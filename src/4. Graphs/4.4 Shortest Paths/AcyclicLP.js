...
export class AcyclicLP {
     ...
     */
    constructor(G, s) {
        this._distTo = Array(G.V()).fill(Number.NEGATIVE_INFINITY);
    ...
    /**
     * Returns the length of a logest path from the source vertex {@code s} to vertex {@code v}.
